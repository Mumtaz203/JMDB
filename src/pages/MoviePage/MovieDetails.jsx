...
import { movieImages } from "../../movieAssets"; // Poster ve banner eşleştirme
...
function MovieDetails() {
    ...
    const { loading: movieLoading, error: movieError, data: movieData } = useQuery(GET_MOVIE_DETAILS, {
        ...
        fetchPolicy: "cache-and-network" // Flicker önlendi
    });
    ...
    // Resimler için useMemo her zaman çalışır, koşulsuz
    const images = useMemo(() => {
        if (!movieData?.getMovie) return {};
        const idKey = String(movieData.getMovie.id);  // ID'yi string yap
